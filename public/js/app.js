...
;(function () {
    var calculatorAPP = {
         ...
         */
        buttonActions: function buttonActions() {
            var self = this;
         ...
         * @returns {Boolean}
         */
        isNumberPress: function isNumberPress(e) {
         ...
         * @returns {Boolean}
         */
        isNumberFloatPress: function isNumberFloatPress(e, val) {
            if (this.isNumberPress(e)) {
                return true;
            }
            if (e.which === 190 && val.indexOf(".") < 0) {
         ...
         * @return float
         */
        getRememberValue: function getRememberValue() {
         ...
         * @param flaot val 
         */
        setRememberValue: function setRememberValue(val) {
         ...
         * @param string action 
         */
        setRememberAction: function setRememberAction(action) {
         ...
         * @return string
         */
        getRememberAction: function getRememberAction() {
        ...
        action: {
             ...
             * Action -
             */
            minus: function minus(val1, val2) {
                return val1 - val2;
            },
            /**
             * Action x
             */
            multiple: function multiple(val1, val2) {
                return val1 * val2;
            },
            /**
             * Action /
             */
            divide: function divide(val1, val2) {
                if (val2 === 0) {
                    return false;
                }
                return val1 / val2;
        ...
        logSave: function logSave(logText) {
...
");
    ...
    logsAPP = {
        ...
        loadLogsByName: function loadLogsByName() {
            //Check name
            var self = this,
        ...
        loadLogsById: function loadLogsById(id) {
            var self = this;
        ...
        addOptionToDrop: function addOptionToDrop(id, name) {
            //Check for same ID
